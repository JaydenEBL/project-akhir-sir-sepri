...
@app.route('/')
@app.route('/perpustakaan sepatu dunia')
def perpus():
    return render_template('perpustakaanSEPATU.html')
...
def simpan():
    if session.get("user"):
        ...
        merek_sepatu = request.form["merek_sepatu"]
        ...
        data = ("", nama, ukuran_sepatu, merek_sepatu, tanggal_peminjaman, tanggal_pengembalian )
...
def aksiupdate():
    if session.get("user"):
        ...
        query = ("update siswa set nama = %s, ukuran_sepatu = %s, merek_sepatu = %s, tanggal_peminjaman = %s, tanggal_pengembalian = %s where id = %s")
        data = (nama, ukuran_sepatu, merek_sepatu, tanggal_peminjaman, tanggal_pengembalian, id, )
